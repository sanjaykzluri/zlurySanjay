...
import Chip from "../../../../../../components/Users/Applications/Modals/FiltersRenderer/RuleChip";
...
export default function DepartmentTags({ department_tags, setDepartmentTags }) {
	...
	return (
		<div className="autosuggest__container">
			<div className="chip__container__rule">
				<div>
					<Chip
						inputArea={
