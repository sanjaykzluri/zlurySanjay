...
export function RemoveLicense(props) {
	return (
		<>
			<div className="d-flex justify-content-around form-row">
				<label htmlFor="select_removal_date">Select Removal Date</label>
				<Select
					className="select_width"
					isOptionsLoading={false}
					value={props?.state?.removal_date}
					options={downgradeorremoveLicenseOptions}
					fieldNames={{
						label: "label",
						value: "value",
					}}
					placeholder="Select removal date"
					onChange={(e) =>
